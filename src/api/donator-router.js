...
donRouter.get('/donator/driver-routes', auth('user'), (req, res, next) => {
...
donRouter.get('/donator/driver-routes/:name', auth('user'), (req, res, next) => {
  users.findOne({
...
donRouter.post('/donator/driver-routes/donation/:name', auth('user'), (req, res, next) => {
  let donate = {
